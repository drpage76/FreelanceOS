  ...
  return (
    <div className="w-full bg-white rounded-[40px] shadow-2xl overflow-hidden p-6 md:p-8 border border-slate-100 max-h-full overflow-y-auto">
      <div className="text-center mb-6 md:mb-8">
        ...
        <h1 className="text-xl md:text-2xl font-black text-slate-900 tracking-tight">Cloud Workspace</h1>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-4 py-1 md:py-2">
          ...
          <span className="text-[8px] md:text-[9px] font-black text-slate-300 uppercase tracking-widest">or email</span>
          <div className="flex-1 h-px bg-slate-100"></div>
        </div>

        <form onSubmit={handleAuth} className="space-y-3 md:space-y-4">
          <div className="space-y-1">
            <label className="text-[8px] md:text-[9px] font-black text-slate-400 uppercase tracking-widest block px-1">Email</label>
            <input 
              type="email" 
              required
          ...
          <div className="space-y-1">
            <label className="text-[8px] md:text-[9px] font-black text-slate-400 uppercase tracking-widest block px-1">Password</label>
            <input 
              type="password" 
              required
              className="w-full px-4 py-2.5 md:px-5 md:py-3 bg-slate-50 border border-slate-200 rounded-xl font-bold outline-none focus:ring-2 focus:ring-indigo-500 transition-all text-sm"
