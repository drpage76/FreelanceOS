                ...
                filteredJobs.map((job) => {
                  ...
                  return (
                    <tr key={job.id} className="hover:bg-slate-50/50 transition-colors group">
                      ...
                      <td className="p-8 text-right font-black text-slate-900 text-lg tracking-tight">
                        {formatCurrency(job.totalRecharge, state.user)}
                      </td>
                      ...
                      <td className="p-8">
                        <div className="flex items-center justify-center gap-3">
                          <Link
                            to={`/jobs/${job.id}`}
                            className="bg-slate-900 text-white w-11 h-11 flex items-center justify-center rounded-[18px] hover:bg-indigo-600 transition-all shadow-md"
                          >
                          ...
                          {!hasInvoice && job.status !== JobStatus.CANCELLED && (
                            <button
                              onClick={() => startQuickInvoice(job.id)}
                              className="bg-emerald-50 text-emerald-600 border border-emerald-100 w-11 h-11 flex items-center justify-center rounded-[18px] hover:bg-emerald-600 hover:text-white transition-all"
                            >
